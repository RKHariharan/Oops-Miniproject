...
public class BankDatabase
{
   ...
   public BankDatabase()
   {
      ...
      Account accounts1 = new Account("Hariharan", 12345, 11111, 1000.0, 1200.0, 0);
      Account accounts2 = new Account("Jeganath", 98765, 22222, 200.0, 200.0, 0);
      Account accounts3 = new Account("Jaswanthlal", 19234, 33333, 200.0, 200.0, 0);
      Account accounts4 = new Account("Kathier", 99999, 00000, 0, 0, 1);
